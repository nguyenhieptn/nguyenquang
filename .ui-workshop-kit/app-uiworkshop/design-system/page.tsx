  ...
  return (
    <div className="grid gap-6">
      <div className="grid gap-1.5">
        <h1 className="text-2xl font-bold tracking-tight">Bộ nhận diện & component</h1>
      ...
      <Card>
        <CardBody>
          ...
          <p className="text-sm text-body-ink">
            Liệt kê ở đây: dải màu gọi theo tên token, các giọng chữ, các primitive
            <code className="mx-1 font-mono">@/components/ui/*</code> ở đủ biến thể. Đây là bảng tra
            khi dựng mọi màn khác.
          </p>
        </CardBody>
      </Card>
    </div>
