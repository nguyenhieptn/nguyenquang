...
export async function getClanOverview(): Promise<Result<ClanOverview>> {
  throw new Error('NOT_IMPLEMENTED — story 1-3');
}
...
export async function getBranchView(_headPersonId: string): Promise<Result<BranchView>> {
  throw new Error('NOT_IMPLEMENTED — story 1-3');
}
...
export async function getAncestryPath(_personId: string): Promise<Result<AncestryPath>> {
  throw new Error('NOT_IMPLEMENTED — story 1-3');
}
...
export async function searchPersons(_query: string): Promise<Result<SearchHit[]>> {
  throw new Error('NOT_IMPLEMENTED — story 1-3');
}
