  ...
  return (
    <main className="mx-auto max-w-[900px] px-6 py-10">
      ...
      <Button asChild variant="outline" className="mt-4 h-11 text-[17px]">
        <a href="/ban-duyet/nap-khung/mau" download>
          Tải file mẫu
        </a>
      </Button>
...
function KhoiCanhBao({
  ...
  if (!nghiTrung && !chaKhongThay) return null;
...
function CaoTrao({ ketQua }: { ketQua: SeedCommitResult }) {
  return (
    <main className="mx-auto max-w-[900px] px-6 py-24 text-center">
      ...
      {/* <a> thường (không phải Link): tải lại trang là cách reset trọn pha nạp. */}
      <p className="mt-10">
        <a
          href="/ban-duyet/nap-khung"
    ...
    <main className="mx-auto max-w-[1280px] px-6 py-10">
      <div className="flex flex-wrap items-end justify-between gap-4">
        ...
        <div className="flex items-center gap-3">
          ...
          <Button type="button" variant="ghost" onClick={boTep} className="h-11 text-[17px]">
            Bỏ tệp này
          </Button>
        </div>
      </div>
            ...
            {dongTheoLoc.map((d) => {
              ...
              return (
                ...
                <Fragment key={d.index}>
                  ...
                  {nghiTrung || d.canhBao.includes('father-not-found') ? (
